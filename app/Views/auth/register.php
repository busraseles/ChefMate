...
<head>
    ...
    <title>ChefMate.AI — Kayıt Ol</title>
    ...
    <style>
        body { font-family:'Inter',sans-serif; margin:0; min-height:100vh; display:flex; align-items:center; justify-content:center; background-color:#792b2b; background-image:url('../hero.jpg'); background-size:cover; background-position:center; position:relative; padding:20px 0; }
        ...
        @media (max-width:480px) {
          ...
          .brand-title { font-size:1.7rem; margin-bottom:24px; }
    ...
    <div class="login-card">
        ...
        <form method="POST" action="register">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" placeholder="Ad Soyad" value="<?= htmlspecialchars($oldName) ?>" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" name="password" placeholder="Şifre (en az 6 karakter)" required>
            </div>
            <div class="form-group">
                <i class="fas fa-lock input-icon"></i>
        ...
        <div class="bottom-text">Zaten hesabınız var mı? <a href="login">Giriş Yapın</a></div>
        <div class="bottom-text mt-2"><a href="." style="font-size:0.8rem;">← Ana Sayfaya Dön</a></div>
    </div>
